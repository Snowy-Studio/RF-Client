...
namespace DTAConfig.Settings
{
    ...
    public class FileSettingCheckBox : SettingCheckBoxBase, IFileSetting
    {
        ...
        public override void GetAttributes(Rampastring.Tools.IniFile iniFile)
        {
        ...
        public override void ParseControlINIAttribute(Rampastring.Tools.IniFile iniFile, string key, string value)
        {
            switch (key)
            {
        ...
        public override void Load()
        {
            if (useLegacyImplementation)
                ...
                Checked = UserINISettings.Instance.SettingsIni.GetValue(SettingSection, SettingKey, DefaultValue);
        ...
        public override bool Save()
        {
            ...
            UserINISettings.Instance.SettingsIni.SetValue(SettingSection, SettingKey, Checked);
            return RestartRequired && (Checked != originalState);
        }
    }
}
